...
template <>
struct Converter<unsigned long> {  // NOLINT(运行时/INT)。
  static v8::Local<v8::Value> ToV8(v8::Isolate* isolate,
                                   unsigned long val) {  // NOLINT(运行时/INT)。
    return v8::Integer::New(isolate, val);
  }
  static bool FromV8(v8::Isolate* isolate,
                     v8::Local<v8::Value> val,
                     unsigned long* out) {  // NOLINT(运行时/INT)。
...
#endif  // Shell_COMMON_GIN_CONVERTERS_STD_CONFERTER_H_
